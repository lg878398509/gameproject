...
void Java_com_longer_playdoudou_NativeRender_nativeDataPoolSize(JNIEnv* env,
															jobject thiz, 
															jint type, 
															jint size){
...
void Java_com_longer_playdoudou_NativeRender_nativeAllocTextureBuffers(JNIEnv* env, jobject thiz, jint length){
...
void Java_com_longer_playdoudou_NativeRender_nativeSetTextureBuffer(JNIEnv* env, jobject thiz, jobject textureData){
...
void Java_com_longer_playdoudou_NativeRender_nativeAlloc(JNIEnv*  env,
													 jobject thiz, 
													 jint spriteNO, 
													 jobject sprite){
    ...
    //Class specific code
	if(type == CREATURE){
	    jclass creature = (*env)->FindClass(env, "com/longer/playdoudou/Creature");
...
void Java_com_longer_playdoudou_NativeRender_nativeFreeSprites(JNIEnv* env, jobject thiz){
	GLSprite* currSprt;
	int spritesToFree;
	int i;
	int j;
...
void Java_com_longer_playdoudou_NativeRender_nativeFreeTex(JNIEnv* env, jobject thiz, jint index){
