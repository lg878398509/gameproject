...
import com.longer.playdoudou.UI.UIHandler;
import com.longer.playdoudou.fileloader.Level;
import com.longer.playdoudou.fileloader.Map;
import com.longer.playdoudou.fileloader.MapLoader;
import com.longer.playdoudou.fileloader.TowerLoader;
import com.longer.playdoudou.fileloader.WaveLoader;
import com.longer.playdoudou.multiplayer.MultiplayerGameLoop;
import com.longer.playdoudou.multiplayer.MultiplayerService;
import com.longer.playdoudou.textures.TextureLibraryLoader;
...
public class GameInit extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			...
			mapChoice = extras.getInt("com.longer.playdoudou.menu.map");
			difficulty = extras.getInt("com.longer.playdoudou.menu.difficulty");
			gameMode = extras.getInt("com.longer.playdoudou.menu.wave");
		}
		...
		if (difficulty == 0) {
			...
			p = new Player(difficulty, 10, 50, 10);
		} else { // resume.
