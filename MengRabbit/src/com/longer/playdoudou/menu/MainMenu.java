...
import com.longer.playdoudou.multiplayer.MultiplayerOp;
...
//					mTable.setVisibility(View.INVISIBLE);
					...
					StartGame.putExtra("com.longer.playdoudou.menu.map", 0);
					StartGame.putExtra("com.longer.playdoudou.menu.difficulty", 0);
					// Since this is not a multiplayergame we will send 0 to
					// gameinit
					StartGame.putExtra("com.longer.playdoudou.menu.wave", 0);
					startActivity(StartGame);
				}
			});
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			pInfo = getPackageManager().getPackageInfo("com.longer.playdoudou",
