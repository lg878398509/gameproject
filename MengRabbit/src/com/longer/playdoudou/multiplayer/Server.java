...
public class Server extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			MAP = extras.getInt("com.longer.playdoudou.multiplayer.map");
			if (MAP == 7) {
				Random randomGenerator = new Random();
				MAP = randomGenerator.nextInt(6) + 1;
			}
			DIFFICULTY = extras
					.getInt("com.longer.playdoudou.multiplayer.difficulty");
			GAMEMODE = extras.getInt("com.longer.playdoudou.multiplayer.gamemode");
		}
	...
	private void startGame(BluetoothSocket socket) {
		...
		StartGame.putExtra("com.longer.playdoudou.menu.map", MAP);
