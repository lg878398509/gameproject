	...
	public void onCreate(Bundle savedInstanceState) {
		...
		StartButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				StartServer.putExtra("com.longer.playdoudou.multiplayer.map",
						mapId + 1);
				StartServer.putExtra(
						"com.longer.playdoudou.multiplayer.difficulty", difId);
				StartServer.putExtra("com.longer.playdoudou.multiplayer.gamemode",
						modeId + 1);
